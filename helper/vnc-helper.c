...
static void cmd_registry_read(SOCKET sock, const char *json)
{
    char key[1024] = {0};
...
static void cmd_registry_write(SOCKET sock, const char *json)
{
    char key[1024] = {0};
    char value_name[512] = {0};
    char reg_type[32] = {0};
...
static void cmd_registry_list(SOCKET sock, const char *json)
{
    char key[1024] = {0};
...
static void cmd_process_list(SOCKET sock)
{
...
static void cmd_process_kill(SOCKET sock, const char *json)
{
    int pid = 0;
    char name[256] = {0};
...
static void cmd_service_list(SOCKET sock)
{
...
static void cmd_service_control(SOCKET sock, const char *json)
{
    char name[256] = {0};
    char action[32] = {0};
